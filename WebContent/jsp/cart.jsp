			...
			<tr>
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td><img src="<%=basePath %>ad/page_ad.jpg" width="666" height="89" />
								<table width="100%" border="0" cellspacing="0">
									<tr>
										<td><img src="<%=basePath %>images/buy1.gif" width="635" height="38" />
										</td>
									</tr>
									<tr>
										<td>
									...
									<c:set var="sum" value="0" > </c:set>
											...
											<div style="text-align:right; margin-top:10px">
												<a
													...
													src="<%=basePath %>images/gwc_jx.gif" border="0" /> </a>

												&nbsp;&nbsp;&nbsp;&nbsp;<a
													href="order.jsp"><img
													src="<%=basePath %>images/gwc_buy.gif" border="0" /> </a>
											</div>
										</td>
									</tr>
								</table>
