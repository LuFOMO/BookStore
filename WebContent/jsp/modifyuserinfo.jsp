			...
			<tr>
				<td width="25%">
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="<%=basePath %>images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="<%=basePath %>jsp/orderlist.jsp">订单查询</a>
							</td>
						</tr>
				...
				<td>
					<div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="<%=basePath %>jsp/index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="<%=basePath %>jsp/myAccount.jsp">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改
					</div>
							...
							<td>
								...
								<input type="hidden" name="id" value="${u.id}">
									...
									<p style="text-align:center">
										<input type="image" src="<%=basePath %>images/botton_gif_025.gif" border="0">
									</p>
