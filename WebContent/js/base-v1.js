 ...
 */
function login() {
    return location.href = "http://localhost:8090/user/showLogin";
}
function regist() {
    return location.href = "http://localhost:8090/user/showRegister";
}
...
function search(a) {
    var b = "http://localhost:8088/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
